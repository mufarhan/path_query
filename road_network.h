...
public:
    ...
    void get_anc_dist(ContractionHierarchy &ch, NodeID v, std::vector<CHNeighbor> &result);
    void get_anc_dist(ContractionHierarchy &ch, ContractionIndex &tcl, NodeID v, uint16_t h_max, std::vector<Neighbor> &result);//, size_t &trunc_anc, size_t &untrunc_anc);
    ...
    std::vector<NodeID> query_path(ContractionHierarchy &ch, ContractionIndex &tcl, NodeID v, NodeID w);
    ...
    void path_to_anc(ContractionHierarchy &ch, ContractionIndex &tcl, NodeID v, uint16_t w, std::vector<QNode> &anc_dist, std::vector<NodeID> &result);
    ...
    void unpack_convex_path(ContractionIndex &tcl, NodeID v, uint16_t w, std::vector<NodeID> &result);
    ...
    void customise_hub_labelling(ContractionHierarchy &ch, ContractionIndex &tcl);
